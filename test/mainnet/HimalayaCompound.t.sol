 ...
 */
contract HimalayaCompoundUnitTests is
    HimalayaCompoundUtils,
    ConnextUtils,
    Utils
{
    ...
    function test_handleOutboundFromV2ToV3() public {
        ...
        migration.amount = compoundV2.getDepositBalanceV2(
            ALICE,
            address(cETHV2)
        );
    ...
    function test_handleOutboundWithBorrowFromV2ToV3() public {
        ...
        migration.debtAmount = compoundV2.getBorrowBalanceV2(
            ALICE,
            address(cUSDCV2)
        );
        migration.toChain = 137; //Polygon
    ...
    function test_handleOutboundFromV3ToV3() public {
        ...
        ICompoundV3(migration.fromMarket).allow(
            address(himalayaCompound),
            true
        );
    ...
    function test_handleOutboundWithBorrowFromV3ToV3() public {
        ...
        migration.debtAssetOrigin = IERC20(USDC);
        migration.debtAssetDest = IERC20(USDC_Polygon);
        migration.debtAmount = compoundV3.getBorrowBalanceV3(
            ALICE,
            USDC,
            cUSDCV3
        );
    ...
    function test_handleOutboundWithBorrowFromV3ToV3WithArbitraryAmounts(
        ...
        uint256 userDepositAmount = compoundV3.getDepositBalanceV3(
            ALICE,
            WETH,
            cUSDCV3
        );
        uint256 userDebtAmount = compoundV3.getBorrowBalanceV3(
            ALICE,
            USDC,
            cUSDCV3
        );
        ...
        if (
            collateralAmount > userDepositAmount || debtAmount > userDebtAmount
        ) {
            vm.expectRevert(
                HimalayaCompound
                    .HimalayaCompound__handleOutboundFromV3_invalidAmount
                    .selector
            );
            vm.prank(ALICE);
            himalayaCompound.beginXMigration(migration);
    ...
    function test_handleInboundToV3() public {
        ...
        vm.expectRevert(
            HimalayaCompound
                .HimalayaCompound__onlyHimalayaConnext_notAuthorized
                .selector
        );
    ...
    function test_handleInboundToV3WithHimalayaConnextWithInvalidAmount()
        public
    {
        ...
        emit BorrowFailed(
            migration.toMarket,
            address(migration.debtAssetDest),
